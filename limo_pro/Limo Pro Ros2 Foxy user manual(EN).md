...
## 9 Robotic arm control (optional)

> **The Mycobot robotic arm is optional, the standard Limo Pro does not come with a robotic arm**

### (1) Installation and Connection of Mechanical Arms

The Mycobot robotic arm is connected to the LIMO PRO via screws. The LIMO PRO's roof is pre-drilled with 8 M3 screw holes for expansion. Four of these holes arranged in a square pattern are used to match the four square-arranged holes at the bottom of the Mycobot robotic arm, and they are connected together with screws. The corresponding screw hole positions are shown in the figure below.

<img src="./LIMO_image/1机械臂底盘安装孔.png" 
	 alt="机械臂底盘安装孔" 
	 width="250px"
	 style="display:block; margin:0 auto;">

<img src="./LIMO_image/1车顶安装孔.png" 
	 alt="车顶安装孔" 
	 width="300px"
	 style="display:block; margin:0 auto;">

> Note: To ensure consistency between the control of the actual robotic arm and its display in RViz, the installation relationship between the robotic arm and the mobile base must align with the URDF model file in the software package. Specifically, during installation, the display screen of the robotic arm should face the same side as the display screen of the mobile base. At this point, you can tighten the studs through the stud mounting holes on the top of the robotic arm’s base. The schematic diagram of the robotic arm installation is shown below.

<img src="./LIMO_image/2机械臂安装.png" 
	 alt="显示屏安装" 
	 width="450px"
	 style="display:block; margin:0 auto;">

After installation, perform the wiring between the mobile base and the robotic arm. To achieve the basic control functions of the robotic arm, only two connections need to be completed: the power supply wiring for the robotic arm and the serial communication wiring.

① The serial communication between the on-board computer and the robotic arm currently supports two wiring methods:Method 1: Connect the USB port of the on-board computer's expansion interface to the Type-C port of the robotic arm via a Type-C to USB cable.Method 2: Connect the Type-C ports of the on-board computer and the robotic arm respectively with a Type-C to Type-C cable.

② Power supply connection for the robotic arm: Connect the DC interface cable led out from the power source inside the LIMO PRO to the power DC interface on the side of the robotic arm for power supply.

<img src="./LIMO_image/2机械臂接线.png" 
	 alt="机械臂接线" 
	 width="300px"
	 style="display:block; margin:0 auto;">

<img src="./LIMO_image/2电脑接线.png" 
	 alt="车载计算机接线" 
	 width="300px"
	 style="display:block; margin:0 auto;">
...
### (2) Basic Functions of a Mechanical Arm

Before using each function of the mechanical arm, please first check whether the version of the system software package is the latest version.

```bash
pip show pymycobot
```

<img src="./LIMO_image/1终端截图.png" 
	 alt="终端截图" 
	 width="600px"
	 style="display:block; margin:0 auto;">

If the version of the system software package is not the latest, please update it to the latest version first.
...
### 9.1 Use the slider to control the simulated robotic arm (optional)
...
### 9.2 The model following the real robotic arm (optional)
...
### 9.3 GUI control of robotic arm (optional)
