...
​										![2.1.1.1.2P1](../../resourse/2-serialproduct/2.1-280/Pi/2.1.2.3开箱与首次使用/2121图1.png) 

​																	Table 2-2 myCobot Robot Arm [Standard Set]

| Items[Standard Set] | **-Robotic Arm (myCobot 280 Raspberry Pi)** **<br />-Product Manual**<br />-Power Supply<br />-USB-Type C<br />-**HDMI**<br /> |
| ------------------- | ------------------------------------------------------------ |
...
myCobot-280 Raspberry Pi robot weights 860g. Due to the fact that the center of gravity will change along with the movement of the robot during utilization, robot is required to be fixed on a solid base at the beginning. A fixed base, or mobile base are both acceptable.
...
​																		![2.1.1.1.2P1](../../resourse/2-serialproduct/2.1-280/Pi/2.1.2.3开箱与首次使用/PI底座安装.jpg)
...
>
> ![2.1.1.1.2P1](../../resourse/2-serialproduct/2.1-280/Pi/2.1.2.3开箱与首次使用/2111QRcode.png)
...
- Plug the other end into the HDMI port of the robotic arm.
  ...
  ![img](../../resourse/2-serialproduct/2.1-280/Pi/2.1.2.3开箱与首次使用/PI连接4.jpg)

  ![img](../../resourse/2-serialproduct/2.1-280/Pi/2.1.2.3开箱与首次使用/PI连接2.jpg)

  ![img](../../resourse/2-serialproduct/2.1-280/Pi/2.1.2.3开箱与首次使用/PI连接1.jpg)
...
Scan the code to watch the installation tutorial of the suction pump:

​																						![2.1.1.1.2P1](../../resourse/2-serialproduct/2.1-280/Pi/2.1.2.3开箱与首次使用/2111图5.png)
