...
## Steps to Operate the Arms

**Step 1:** Burn the latest **atomMain** for **Atom**.

**Step 2:** Create a Python file on the desktop named as  rasp\_mycobot\_test\_gui.py and copy the following codes.

*Go to [GitHub](https://github.com/elephantrobotics/pymycobot/tree/main/tests) to copy the codes.*
...
**Step 3:** Open the terminal (CTRL+ALT+T), and then type the following commands:
...
**Step 4:** Select baud rate and then click on `connect`.

![](../../../resourse/4-BasicApplication/4.2/4.2.2/2/2.png)

**Step 5:** Set all joints to the zero positions, and click on **Start calibration**.

![](../../../resourse/4-BasicApplication/4.2/4.2.2/2/4.png)

**Step 6:** When **Calibration completed** is shown on the screen, the calibration is finished.

![](../../../resourse/4-BasicApplication/4.2/4.2.2/2/3.png)
